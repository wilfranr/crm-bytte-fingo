...
export const addTarjeta = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error interno del servidor al agregar tarjeta." });
  }
};
...
export const getTarjetasByCliente = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error interno del servidor al obtener tarjetas." });
  }
};
...
export const getTotalTarjetasCount = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        message:
          "Error interno del servidor al obtener el conteo total de tarjetas.",
      });
  }
};
